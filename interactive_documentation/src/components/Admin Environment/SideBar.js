/**
 * @file SideBar.js
 * @description This component represents a sidebar with navigation links and user information.
 ...
 * @param {Function} props.onLogout - The function to handle logout
  ...
  return (
    <div className="sidebar">
      ...
      <nav className="nav-element">
        <ul className="list">
          <Link to="/admin/analytics" className="list-element">
            <li>Analytics</li>
          </Link>
          <Link to="/admin/training-data" className="list-element">
            <li>Training Data</li>
          </Link>
        </ul>
      </nav>
