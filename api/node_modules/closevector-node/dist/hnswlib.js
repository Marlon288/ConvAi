...
class CloseVectorHNSWNode extends closevector_common_1.CloseVectorSaveableVectorStore {
    ...
    saveToCloud(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _options = Object.assign(Object.assign({}, options), { accessKey: this.accessKey, secret: this.secret });
            const uuid = yield (0, io_1.upsertIndex)(this, _options);
            this.uuid = uuid;
            return uuid;
        });
    }
    ...
    static loadFromCloud(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const instance = yield (0, io_1.getIndex)(options);
